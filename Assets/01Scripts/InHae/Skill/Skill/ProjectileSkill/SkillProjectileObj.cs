...
public class SkillProjectileObj : SkillObj
{
    ...
    public override void Initialize(Skill _skill, Transform shootTrm)
    {
        ...
        _penetrationCount = 
            (skill.GetSkillData(SkillFieldDataType.Projectile) as ProjectileSkillDataSO).penetrationCount;
    ...
    protected virtual void OnTriggerEnter(Collider other)
    {
        ...
        {
            if ((skill.GetSkillData(SkillFieldDataType.Projectile) as ProjectileSkillDataSO).reflectionCount 
